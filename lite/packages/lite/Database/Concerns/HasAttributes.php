...
namespace Lite\Database\Concerns;

use DateTimeInterface;
use Carbon\CarbonInterface;
use Lite\Contracts\Database\CastsInboundAttributes;
use Lite\Contracts\Support\Arrayable;
use Lite\Exceptions\JsonEncodingException;
use Lite\Support\Arr;
use Lite\Support\Collection as BaseCollection;
...
trait HasAttributes
{
	...
	/**
	 * The eloquent attribute's original state.
	 *
	 * @var array
	 */
	protected $original = [];
	...
	/**
	 * The eloquent attribute`s which are changed
	 * @var array
	 */
	protected $updated = [];

	/**
	 * The changed eloquent attributes.
	 *
	 * @var array
	 */
	protected $changes = [];
	...
	/**
	 * The storage format of the eloquent's date columns.
	 *
	 * @var string
	 */
	...
	/**
	 * The accessors to append to the eloquent's array form.
	 *
	 * @var array
	 */
	protected $appends = [];
	 ...
	 * when silent saving is on
	 * @var array
	 */
	protected $silentColumns = [
		'updated_at'
	];
